...
| 58 | Lego Brick | Mix | Яркие кубики, контрастные базовые цвета и выраженный рельеф как у настоящих блоков. (игровой конструктор, контраст: высокий) | #F2F4F8 / #FFFFFF / #E10600 / #1A1A1A | 10px | 4px solid #F7D117 | lego |
